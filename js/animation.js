...
typing.to(".fifth", { duration: 1, text: "import java.net.MalformedURLException;", color: "red" })
    ...
    .to(".twenty-five", { duration: 1, text: " // ..." })
    .to(".twenty-six", { duration: 1, text: " Config cnf = new Config();" })
    .to(".twenty-seven", { duration: 1, text: "  URL ipcApiUrl = null;" })
    .to(".twenty-eight", { duration: 1, text: " import co.getanchor.checkout.ipc.IPCException;" })
    .to(".twenty-nine", { duration: 1, text: " try {" })
    .to(".thirty", { duration: 1, text: " ipcApiUrl = new URL('https://getanchor.co/vmp/');", marginLeft: "10px", color: "red" })
    .to(".thirty-one", { duration: 1, text: " } catch (MalformedURLException ex) {" })
    .to(".thirty-two", { duration: 1, text: " // Handle the malformed URL exception" })
    .to(".thirty-three", { duration: 1, text: " }" })
    .to(".thirty-four", { duration: 1, text: " cnf.setIpcUrl(ipcApiUrl);" })
    .to(".thirty-five", { duration: 1, text: " cnf.setLang('en');" })
